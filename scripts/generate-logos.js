...
<svg viewBox="0 0 512 512" width="512" height="512" xmlns="http://www.w3.org/2000/svg">
  ...
  <g filter="url(#paperShadow)">
    ...
    <!-- ==================== TEST PAPER CONTENT ==================== -->
    <!-- ROW 1: Solved Item (Green Checkmark Badge + Horizontal Line) -->
    <g transform="translate(176, 172)">
      <!-- Mini Green Circle Checkmark -->
  ...
  <g transform="translate(330, 275) rotate(38)" filter="url(#softShadow)">
    <g transform="translate(-16, -110)">
      ...
      <!-- Yellow Hexagonal Pencil Body (3 facets with 3D lighting) -->
      ...
      <!-- Wood Cone Tip (Sharpened section) -->
