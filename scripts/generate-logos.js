...
function getInnerGraphicSvg() {
  return `
  <!-- ==================== YELLOW SPARKLE RAYS ==================== -->
  <g transform="translate(136, 185) rotate(-32)">
    <rect x="-8" y="-22" width="16" height="36" rx="8" fill="url(#sparkleGrad)" />
  </g>
  <g transform="translate(134, 218) rotate(12)">
    <rect x="-7" y="-18" width="14" height="32" rx="7" fill="url(#sparkleGrad)" />
  </g>
  ...
  <g filter="url(#paperShadow)">
    ...
    <g transform="translate(176, 172)">
      <circle cx="15" cy="15" r="15" fill="url(#miniGreenGrad)" />
      <path
  ...
  <!-- ==================== 3D STYLIZED PENCIL ==================== -->
  <g transform="translate(330, 275) rotate(38)" filter="url(#softShadow)">
    <g transform="translate(-16, -110)">
      ...
      <rect x="5" y="24" width="22" height="20" rx="2" fill="url(#pencilMetalLight)" />
      ...
      <rect x="6" y="44" width="7" height="115" fill="url(#pencilFacet1)" />
      <rect x="13" y="44" width="9" height="115" fill="url(#pencilFacet2)" />
      <rect x="22" y="44" width="4" height="115" fill="url(#pencilFacet3)" />

      <polygon points="6,159 26,159 16,198" fill="url(#pencilWood)" />
      <path d="M 6,159 Q 11,162 16,159 Q 21,162 26,159 L 16,198 Z" fill="url(#pencilWood)" />
  ...
  <g transform="translate(362, 350)" filter="url(#badgeShadow)">
    <circle cx="0" cy="0" r="48" fill="#ffffff" />
    <circle cx="0" cy="0" r="40" fill="url(#greenBadgeGrad)" />
    <circle cx="0" cy="0" r="40" fill="url(#greenBadgeGlow)" />
...
function getMasterSvg(type = 'fullBleed') {
  const rx = type === 'rounded' ? '108' : '0';
  const innerContent = getInnerGraphicSvg();
  
  // For maskable icons, we center the content in a safe zone (scaled to ~78% and centered at 256, 256)
  const graphicBlock = type === 'maskable'
    ? `<g transform="translate(256, 256) scale(0.78) translate(-256, -256)">${innerContent}</g>`
    : innerContent;
...
<svg viewBox="0 0 512 512" width="512" height="512" xmlns="http://www.w3.org/2000/svg">
  <defs>
    ...
    <linearGradient id="bookPageLeft" x1="100%" y1="50%" x2="0%" y2="50%">
      <stop offset="0%" stopColor="#cbd5e1" />
      <stop offset="25%" stopColor="#f1f5f9" />
      <stop offset="100%" stopColor="#ffffff" />
    </linearGradient>
    <linearGradient id="bookPageRight" x1="0%" y1="50%" x2="100%" y2="50%">
      <stop offset="0%" stopColor="#cbd5e1" />
      <stop offset="25%" stopColor="#f1f5f9" />
      <stop offset="100%" stopColor="#ffffff" />
    </linearGradient>
    <linearGradient id="bookUnderLeft" x1="100%" y1="50%" x2="0%" y2="50%">
      <stop offset="0%" stopColor="#94a3b8" />
      <stop offset="60%" stopColor="#e2e8f0" />
      <stop offset="100%" stopColor="#cbd5e1" />
    </linearGradient>
    <linearGradient id="bookUnderRight" x1="0%" y1="50%" x2="100%" y2="50%">
      <stop offset="0%" stopColor="#94a3b8" />
      <stop offset="60%" stopColor="#e2e8f0" />
      <stop offset="100%" stopColor="#cbd5e1" />
    </linearGradient>
    ...
    <linearGradient id="bookBaseRim" x1="0%" y1="0%" x2="0%" y2="100%">
      <stop offset="0%" stopColor="#0284c7" />
      <stop offset="50%" stopColor="#0369a1" />
      <stop offset="100%" stopColor="#075985" />
    </linearGradient>
    <linearGradient id="bookBaseLip" x1="0%" y1="0%" x2="0%" y2="100%">
    ...
    <linearGradient id="pencilMetalLight" x1="0%" y1="0%" x2="100%" y2="0%">
      <stop offset="0%" stopColor="#93c5fd" />
      <stop offset="35%" stopColor="#e0e7ff" />
      <stop offset="70%" stopColor="#818cf8" />
      <stop offset="100%" stopColor="#6366f1" />
    </linearGradient>
    <linearGradient id="pencilFacet1" x1="0%" y1="0%" x2="100%" y2="0%">
      <stop offset="0%" stopColor="#fde047" />
      <stop offset="100%" stopColor="#facc15" />
    </linearGradient>
    <linearGradient id="pencilFacet2" x1="0%" y1="0%" x2="100%" y2="0%">
      <stop offset="0%" stopColor="#fbbf24" />
      <stop offset="100%" stopColor="#f59e0b" />
    </linearGradient>
    <linearGradient id="pencilFacet3" x1="0%" y1="0%" x2="100%" y2="0%">
    ...
    <linearGradient id="greenBadgeGrad" x1="0%" y1="0%" x2="0%" y2="100%">
      <stop offset="0%" stopColor="#22c55e" />
      <stop offset="60%" stopColor="#16a34a" />
      <stop offset="100%" stopColor="#15803d" />
    </linearGradient>
    <radialGradient id="greenBadgeGlow" cx="40%" cy="30%" r="50%">
      <stop offset="0%" stopColor="#86efac" stopOpacity="0.6" />
      <stop offset="100%" stopColor="#22c55e" stopOpacity="0" />
    </radialGradient>

    <linearGradient id="miniGreenGrad" x1="0%" y1="0%" x2="0%" y2="100%">
      <stop offset="0%" stopColor="#22c55e" />
...
async function run() {
  ...
  const fullBleedSvg = getMasterSvg('fullBleed');
  const roundedSvg = getMasterSvg('rounded');
  const maskableSvg = getMasterSvg('maskable');
  ...
  // 1. PWA Any Icons (512x512, 192x192)
  ...
  // 2. PWA Maskable Icons (With Android safe-zone padding)
  await sharp(maskableBuffer).resize(512, 512).png().toFile(path.join(publicDir, 'pwa-maskable-512x512.png'));
  await sharp(maskableBuffer).resize(192, 192).png().toFile(path.join(publicDir, 'pwa-maskable-192x192.png'));
  await sharp(maskableBuffer).resize(512, 512).png().toFile(path.join(publicDir, 'icon-512.png'));
  await sharp(maskableBuffer).resize(192, 192).png().toFile(path.join(publicDir, 'icon-192.png'));

  // 3. Apple Touch Icon 180x180
  await sharp(fullBleedBuffer).resize(180, 180).png().toFile(path.join(publicDir, 'apple-touch-icon.png'));

  // 4. Favicon 64x64 and 32x32
  await sharp(fullBleedBuffer).resize(64, 64).png().toFile(path.join(publicDir, 'favicon.png'));
  await sharp(fullBleedBuffer).resize(32, 32).png().toFile(path.join(publicDir, 'favicon.ico'));

  console.log('All logo assets (any, maskable, apple-touch, favicons) generated successfully!');
}
