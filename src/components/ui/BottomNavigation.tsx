...
export const BottomNavigation: React.FC = () => {
  ...
  return (
    <nav
      ...
      className="fixed bottom-3 sm:bottom-4 left-0 right-0 z-40 flex justify-center pointer-events-none px-3 sm:px-4 pb-[env(safe-area-inset-bottom,0px)] md:hidden"
    >
