    ...
    >
      ...
      >
        <defs>
          ...
          {/* Ambient Top Glow */}
          <radialGradient id="logoAmbientGlow" cx="50%" cy="30%" r="65%">
            <stop offset="0%" stopColor="#ffffff" stopOpacity="0.28" />
            <stop offset="70%" stopColor="#ffffff" stopOpacity="0" />
          </radialGradient>

          {/* Paper Sheet Gradient */}
          <linearGradient id="logoPaperGrad" x1="0%" y1="0%" x2="0%" y2="100%">
          ...
          {/* Book Page Gradients */}
          <linearGradient id="logoPageLeft" x1="100%" y1="50%" x2="0%" y2="50%">
            <stop offset="0%" stopColor="#cbd5e1" />
            <stop offset="35%" stopColor="#f1f5f9" />
            <stop offset="100%" stopColor="#ffffff" />
          </linearGradient>
          <linearGradient id="logoPageRight" x1="0%" y1="50%" x2="100%" y2="50%">
            <stop offset="0%" stopColor="#cbd5e1" />
            <stop offset="35%" stopColor="#f1f5f9" />
            <stop offset="100%" stopColor="#ffffff" />
          </linearGradient>
          <linearGradient id="logoBookCover" x1="0%" y1="0%" x2="0%" y2="100%">
            <stop offset="0%" stopColor="#0043a8" />
            <stop offset="100%" stopColor="#001d52" />
          </linearGradient>

          {/* Pencil Gradients */}
          <linearGradient id="logoPencilLight" x1="0%" y1="0%" x2="100%" y2="0%">
            <stop offset="0%" stopColor="#fde047" />
            <stop offset="100%" stopColor="#fef08a" />
          </linearGradient>
          <linearGradient id="logoPencilMid" x1="0%" y1="0%" x2="100%" y2="0%">
            <stop offset="0%" stopColor="#f59e0b" />
            <stop offset="100%" stopColor="#fbbf24" />
          </linearGradient>
          <linearGradient id="logoPencilDark" x1="0%" y1="0%" x2="100%" y2="0%">
            <stop offset="0%" stopColor="#d97706" />
            <stop offset="100%" stopColor="#f59e0b" />
          </linearGradient>
          <linearGradient id="logoEraserGrad" x1="0%" y1="0%" x2="100%" y2="100%">
          ...
          <linearGradient id="logoWoodGrad" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stopColor="#fef3c7" />
            <stop offset="100%" stopColor="#fde68a" />
          </linearGradient>

          {/* Green Check Badge Gradient */}
          <linearGradient id="logoGreenBadgeGrad" x1="0%" y1="0%" x2="0%" y2="100%">
            <stop offset="0%" stopColor="#10b981" />
            <stop offset="50%" stopColor="#059669" />
            <stop offset="100%" stopColor="#047857" />
          </linearGradient>
          <linearGradient id="logoGreenBubble" x1="0%" y1="0%" x2="0%" y2="100%">
            <stop offset="0%" stopColor="#34d399" />
            <stop offset="100%" stopColor="#059669" />
          </linearGradient>

          {/* Drop Shadows */}
          <filter id="logoDropShadow" x="-10%" y="-10%" width="125%" height="130%">
        ...
        <rect width="512" height="512" rx="108" fill="url(#logoAmbientGlow)" />
        ...
        <g filter="url(#logoDropShadow)">
          ...
          {/* Left Open Page Base */}
          <path d="M 68 428 C 140 420 216 428 254 440 L 254 360 C 216 350 140 342 68 352 Z" fill="url(#logoPageLeft)" />
          {/* Right Open Page Base */}
          <path d="M 258 440 C 296 428 372 420 444 428 L 444 352 C 372 342 296 350 258 360 Z" fill="url(#logoPageRight)" />
        </g>
        ...
        <g filter="url(#logoDropShadow)">
          ...
          <g transform="translate(134, 320)">
            <circle cx="22" cy="22" r="22" fill="url(#logoGreenBubble)" />
            <path
        ...
        <g transform="translate(366, 255) rotate(34)" filter="url(#logoDropShadow)">
          <g transform="translate(-24, -145)">
            {/* Eraser Top (Pink) */}
            <path d="M 8 0 C 8 -12 40 -12 40 0 L 40 32 L 8 32 Z" fill="url(#logoEraserGrad)" />
            <path d="M 12 0 C 12 -8 24 -8 24 0 L 24 32 L 12 32 Z" fill="#ffffff" opacity="0.35" />

            {/* Silver Metal Band */}
            <rect x="7" y="32" width="34" height="26" rx="2" fill="url(#logoMetalGrad)" />
            ...
            <rect x="8" y="58" width="10" height="175" fill="url(#logoPencilLight)" />
            <rect x="18" y="58" width="14" height="175" fill="url(#logoPencilMid)" />
            <rect x="32" y="58" width="8" height="175" fill="url(#logoPencilDark)" />

            {/* Sharpened Wood Cone */}
            <polygon points="8,233 40,233 24,285" fill="url(#logoWoodGrad)" />
            <path d="M 8,233 Q 18,237 24,233 Q 32,237 40,233 L 24,285 Z" fill="url(#logoWoodGrad)" />
        ...
        <g transform="translate(426, 415)" filter="url(#logoDropShadow)">
          {/* White Border Ring */}
          <circle cx="0" cy="0" r="70" fill="#ffffff" />
          {/* Emerald Sphere */}
          <circle cx="0" cy="0" r="60" fill="url(#logoGreenBadgeGrad)" />
          {/* Top Gloss */}
