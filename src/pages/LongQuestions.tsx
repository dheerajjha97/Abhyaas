        ...
        rightAction={
          <div className="flex items-center gap-1.5">
            ...
            <button
              ...
              className="p-2 rounded-2xl bg-white/80 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-pink-600 dark:text-pink-400 font-bold text-xs flex items-center cursor-pointer shadow-2xs hover:bg-pink-50 dark:hover:bg-pink-950/60 transition-all active:scale-95"
            >
